...
void save_data_to_eeprom() {
    ...
    eeprom_update_byte((uint8_t*)LEFT_ADDR, 1);
    ...
    eeprom_update_word((uint16_t*)(metadata_addr + 1*6 + 2), 1);
    eeprom_update_word((uint16_t*)(metadata_addr + 1*6 + 4), 1);

    eeprom_update_word((uint16_t*)(metadata_addr + 2*6), 3);
    eeprom_update_word((uint16_t*)(metadata_addr + 2*6 + 2), 2);
    eeprom_update_word((uint16_t*)(metadata_addr + 2*6 + 4), 1);

    eeprom_update_word((uint16_t*)(metadata_addr + 3*6), 4);
    eeprom_update_word((uint16_t*)(metadata_addr + 3*6 + 2), 3);
    eeprom_update_word((uint16_t*)(metadata_addr + 3*6 + 4), 2);

    eeprom_update_word((uint16_t*)(metadata_addr + 4*6), 5);
    eeprom_update_word((uint16_t*)(metadata_addr + 4*6 + 2), 3);
    eeprom_update_word((uint16_t*)(metadata_addr + 4*6 + 4), 1);
